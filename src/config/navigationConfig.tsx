import type { NavigationItem, PageType } from "../models/Navigation";

export const NAVIGATION_MENU_ITEMS: NavigationItem[] = [
  {
    id: "dashboard",
    label: "Dashboard",
    icon: (
...
export const WORK_IN_PROGRESS_PAGES: Record<PageType, { title: string; description: string; icon: string } | null> = {
  dashboard: null,
  cader: null,
  employees: null,
  jobdesk: {
